...
function renderNode(node, index, siblings, parent, defaultRenderer) {
  if (Platform.OS === "ios") {
    if (node.name == "iframe") {
      ...
      var iframeHtml = `<iframe width=\"${atribute.width}\" height=\"${
        atribute.height
      }\" src=\"${
        atribute.src
    ...
    if (node.name == "div") {
      ...
      var iframeHtml = `<iframe src=\"${atribute.src}" width=\"${width /
        1.7}\" frameborder=\"0\" allow=\"autoplay; encrypted-media\" allowfullscreen></iframe>`;
      return (
  ...
  if (node.name == "img") {
    ...
    var imgHtml = `<img src=\"${source}\" width=\"${width /
      1.5}\" height=\"${height / 2.7}\" >`;
    return <HTMLView value={imgHtml} />;
  }
}
          ...
          <ScrollView contentContainerStyle={Styles.scroll}>
            ...
            >
              <Text
                ...
                style={[
                  ...
                  {
                    fontSize:
                      orientation === "PORTRAIT" ? width / 15 : height / 15
                  }
                ]}
              >
                {this.state.title}
            ...
            <View style={[Styles.itemBottom, { width: width / 1.2 }]}>
              {this.state.logo == null ? (
                <Image
                  ...
                  source={require("../../../../assets/images/default_appLogo.png")}
                  resizeMode="stretch"
                />
              ) : (
                <Image
                  ...
                  source={{ uri: API_HTML_ROOT + this.state.logo.url }}
                  resizeMode="stretch"
                />
              )}
                ...
                <View style={{ flex: 1 }}>
                  <View style={{ flexDirection: "row", padding: 10 }}>
                    ...
                    <View style={Styles.contactView}>
                      <View style={{ justifyContent: "center" }}>
                        <Image
                          source={require("../../../../assets/images/icon_website.png")}
                        />
                      </View>
                      <Text style={Styles.contactText}>
                        {this.state.website}
            ...
            <View style={[Styles.itemBottom, { width: width / 1.2 }]}>
              <View style={Styles.buttonContainer}>
                ...
                <View style={{ flex: 1 }} />
                <Button dark onPress={this._share}>
                  SHARE
                </Button>
              </View>
            </View>
